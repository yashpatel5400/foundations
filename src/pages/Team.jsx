...
const TEAM = [
  {
    ...
    bio: [
      ...
      `Founded Spectral Labs to pursue the open scientific questions that will determine whether neural PDE solvers can become reliable, scalable tools for engineering design.`,
    ],
    links: [
